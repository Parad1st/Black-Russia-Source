...
Для этого советую использовать DropBox, так как там можно получить прямую ссылку, вместо "0" в конце написать "1"
...
Теперь давайте скачаем нужные файлы для игрвы. К сожалению я не смог их добавить на гитхаб так что залил его на Google Drive. Скачать - тык*
