...
public class DialogClientSettingsWeaponsFragment extends Fragment implements ISaveableFragment {
    ...
    public static DialogClientSettingsWeaponsFragment createInstance(String txt)
    {
        DialogClientSettingsWeaponsFragment fragment = new DialogClientSettingsWeaponsFragment();
        return fragment;
    }

    public DialogClientSettingsWeaponsFragment setRoot(ViewGroup root)
    {
        mParentView = root;
        return this;
    }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        mRootView = inflater.inflate(R.layout.dialog_settings_weapons,container,false);
    ...
    private void setSeekBarListeners()
    {
        ...
        for(int i = DialogClientSettings.mSettingsWeaponsStart; i < DialogClientSettings.mSettingsWeaponsEnd; i++)
        {
